...
const changeBlockStatus = ($lockBtn) => {
    let iconTemplate = `
        <img
            ...
            height="30">
    `;
    if ($lockBtn.firstElementChild.classList.contains('lock')) {
        iconTemplate = `
            <img
...
const createInfoMessage = ($el) => {
    ...
    setTimeout(() => {
        // TODO Сделать логику удаления сообщения Скопировано
        const $parentInfo = document.getElementById("info").parentNode;
        console.log(3333, $parentInfo);
    }, 3000);
}
